...
Your task is to install or re-engage a shared project memory system named `AIMemory`, and to wire this project so that Codex, Claude Code, Gemini CLI, and other file-aware coding agents naturally read and update that memory on future turns.
